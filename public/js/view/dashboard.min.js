...
/*!****************************************!*\
  !*** ./resources/js/view/dashboard.js ***!
  \****************************************/
  ...
  $.ajax({
    ...
    success: function success(result) {
      ...
      if (data) {
        ...
        chart1.data.labels = data.map(function (o) {
          return o.created_at;
        });
        chart1.data.datasets[0].data = data.map(function (o) {
          return o.order_total;
        });
        chart1.update();
        chart2.data.labels = data.map(function (o) {
          return o.created_at;
        });
        chart2.data.datasets[0].data = data.map(function (o) {
          return o.proceeds;
        });
        chart2.update();
      } else if (error) {
